...
export const ui = {
  ...
  fr: {
    ...
    heroSubtitle: 'Des décisions de relecture qui vivent dans votre source',
    heroTagline:
    ...
    factDepsValue: 'Aucune au-delà d’une installation TeX Live. L’outil de fusion n’utilise que la bibliothèque standard de Python.',
    factLicence: 'Licence',
    ...
    f1b: 'Compilez en review pour voir le balisage, en final pour lire le texte accepté, ou en original pour retrouver l’état initial. Le fichier ne se dédouble jamais.',
    ...
    f4b: 'L’outil texchanges-merge met à jour les statuts ou retire entièrement le balisage, sur place ou vers un nouveau fichier, avec une simulation préalable.',
