...
\hypersetup{
  ...
  linkcolor=txblue,
  urlcolor=txblue,
  pdftitle={Texchanges 0.2.3 Manual},
...
\author{Phuc Nguyen}
\date{Version 0.2.3, 15 August 2026}
...
use the same package line. The distributable explicit example is named
\path{texchanges-explicit-review.tex}; the automatic comparison example uses
\path{texchanges-original.tex}, \path{texchanges-revised.tex}, and
\path{texchanges-review.tex} with a top-level \path{latexmkrc}.
