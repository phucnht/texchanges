...
For anything larger (new commands, new package options, CLI behavior changes) please open an issue first and describe the design. The [roadmap](https://texchanges.dev/roadmap/) lists where the project is headed; work that fits it is much more likely to land.
